...
(
    20
) NOT NULL DEFAULT 'USER', -- USER / ADMIN
...
(
    20
) NOT NULL DEFAULT 'ACTIVE', -- ACTIVE / ARCHIVED / DELETED
    description TEXT,
...
(
    30
) NOT NULL, -- CREATE / UPDATE / NOTE / COMPLETE
    note TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
    );
...
VALUES ('admin', '586034f', 'ADMIN'),
       ('demo', '2efde3', 'USER');

INSERT INTO items (name, category, status, description, priority, owner_id)
VALUES ('範例項目 A', 'GENERAL', 'ACTIVE', '這是第一個範例項目', 3, 2),
